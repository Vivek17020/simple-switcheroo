...
interface SEOProps {
  ...
  noindex?: boolean; // Dynamic robots meta control
  nofollow?: boolean; // Dynamic robots meta control
}
...
export function SEOHead({
  ...
  // Build robots meta content dynamically
  const robotsParts = [
  ...
  return (
    <Helmet>
      ...
      {/* Google Discover optimization - dynamic robots */}
