...
export function Web3Hero() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#6A5BFF]/10 via-white to-[#4AC4FF]/10 py-24">
      {/* Decorative elements */}
      ...
      <div className="container relative mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 pt-6">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-gray-200 shadow-sm">
              <Code2 className="w-5 h-5 text-[#6A5BFF]" />
              <span className="text-sm font-medium text-gray-700">Hands-on Tutorials</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-gray-200 shadow-sm">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-gray-200 shadow-sm">
              ...
              <span className="text-sm font-medium text-gray-700">Indian Context</span>
            </div>
          </div>
