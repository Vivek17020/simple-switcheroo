          ...
          <nav className="flex items-center space-x-6 text-sm font-medium" data-no-translate>
              ...
              if (hasSubcategories) {
                return (
                  <div key={category.id} className="relative group/category">
                    ...
                    <div className="absolute top-full left-0 mt-2 w-56 bg-popover border border-border shadow-xl rounded-md opacity-0 invisible group-hover/category:opacity-100 group-hover/category:visible transition-all duration-200 z-[99999] pointer-events-none group-hover/category:pointer-events-auto" data-no-translate>
            ...
            {jobsCategory && jobsSubcategories.length > 0 && (
              <div className="relative group/jobs">
                ...
                <div className="absolute top-full left-0 mt-2 w-56 bg-popover border border-border shadow-xl rounded-md opacity-0 invisible group-hover/jobs:opacity-100 group-hover/jobs:visible transition-all duration-200 z-[99999] pointer-events-none group-hover/jobs:pointer-events-auto" data-no-translate>
