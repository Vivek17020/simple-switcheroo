      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-3">
          <div className="flex gap-2 text-sm text-blue-600 dark:text-blue-400">
            ...
            <div>
              <p className="font-medium">Google Discover Optimized:</p>
              <ul className="mt-1 space-y-1 text-xs">
                <li>• <strong>6-7 slides</strong> with narrative flow</li>
                <li>• Cover, content, summary & CTA slides</li>
                <li>• <strong>Title under 70 chars</strong> with engaging hooks</li>
                <li>• <strong>High-quality 1200×1600px images</strong></li>
                <li>• Headlines + supporting subtext</li>
                <li>• SEO meta description (140-155 chars)</li>
