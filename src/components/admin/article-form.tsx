    ...
    try {
      ...
      if (!validation.isValid) {
        toast({
          ...
          description: `Found ${validation.issues.length} issue(s). Check debugger for details.`,
          variant: "destructive",
        });
      } else if (validation.stats.changesApplied > 0) {
        toast({
          title: "Content Auto-Fixed",
          description: `Applied ${validation.stats.changesApplied} automatic fix(es).`,
        });
