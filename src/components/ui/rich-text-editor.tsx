...
export function RichTextEditor({ content, onChange, placeholder }: RichTextEditorProps) {
  ...
  const editor = useEditor({
    extensions: [
      ...
      Image.configure({
        HTMLAttributes: {
          class: 'w-full max-w-full h-auto my-6 mx-auto rounded-lg shadow-sm block',
          loading: 'lazy',
          decoding: 'async'
        },
      }),
    ...
    editorProps: {
      attributes: {
        class: 'article-content prose prose-lg max-w-none dark:prose-invert min-h-[400px] focus:outline-none p-4 prose-img:rounded-xl prose-img:my-6 prose-p:my-4 prose-p:leading-relaxed prose-figure:my-8 prose-figcaption:text-center prose-figcaption:text-sm prose-figcaption:text-muted-foreground prose-figcaption:mt-2 prose-figcaption:italic prose-h2:mt-8 prose-h2:mb-4 prose-h3:mt-6 prose-h3:mb-3 prose-ul:my-6 prose-ol:my-6 prose-li:my-2',
      },
    },
  });
