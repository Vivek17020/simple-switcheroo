...
// Retry wrapper for lazy imports to handle transient chunk load/service worker issues
const lazyWithRetry = (importer: () => Promise<any>) => lazy(async () => {
  try {
...
const NewsHomepage = lazyWithRetry(() => import("./pages/NewsHomepage"));
