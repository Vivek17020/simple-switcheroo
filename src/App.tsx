...
const Web3ForIndia = lazy(() => import("@/pages/Web3ForIndia"));
const Web3Layout = lazy(() => import("@/layouts/Web3Layout"));
const Web3CategoryPage = lazy(() => import("@/pages/Web3CategoryPage"));
const Web3ArticlePage = lazy(() => import("@/pages/Web3ArticlePage"));
const Web3AboutPage = lazy(() => import("@/pages/Web3AboutPage"));
const Web3Dashboard = lazy(() => import("@/pages/Web3Dashboard"));
const Web3LearningPathDetail = lazy(() => import("@/pages/Web3LearningPathDetail"));
const Web3SitemapXML = lazy(() => import("@/pages/Web3SitemapXML"));
const Web3CertificateVerify = lazy(() => import("@/pages/Web3CertificateVerify"));
const Web3CodePlayground = lazy(() => import("@/pages/Web3CodePlayground"));
const Web3SnippetPage = lazy(() => import("@/pages/Web3SnippetPage"));

// UPSCBriefs - UPSC Preparation Section
const UPSCLayout = lazy(() => import("@/layouts/UPSCLayout"));
const UPSCBriefs = lazy(() => import("@/pages/UPSCBriefs"));
const UPSCCategoryPage = lazy(() => import("@/pages/UPSCCategoryPage"));
const UPSCArticlePage = lazy(() => import("@/pages/UPSCArticlePage"));
const UPSCAboutPage = lazy(() => import("@/pages/UPSCAboutPage"));
const UPSCPrelimsPage = lazy(() => import("@/pages/UPSCPrelimsPage"));
const UPSCMainsPage = lazy(() => import("@/pages/UPSCMainsPage"));
const UPSCCurrentAffairsPage = lazy(() => import("@/pages/UPSCCurrentAffairsPage"));
const UPSCPracticePage = lazy(() => import("@/pages/UPSCPracticePage"));
const UPSCFlashcardsPage = lazy(() => import("@/pages/UPSCFlashcardsPage"));
const UPSCResourcesPage = lazy(() => import("@/pages/UPSCResourcesPage"));
const UPSCOptionalPage = lazy(() => import("@/pages/UPSCOptionalPage"));
const UPSCContactPage = lazy(() => import("@/pages/UPSCContactPage"));
const UPSCQuizPage = lazy(() => import("@/pages/UPSCQuizPage"));
const UPSCDashboardPage = lazy(() => import("@/pages/UPSCDashboardPage"));

// Admin UPSC Pages
const AdminUPSCQuizzes = lazy(() => import("@/pages/AdminUPSCQuizzes"));
const AdminUPSCFlashcards = lazy(() => import("@/pages/AdminUPSCFlashcards"));
    ...
    <HelmetProvider>
      <ThemeProvider>
        <AuthProvider>
              ...
              <BrowserRouter>
                <ErrorBoundary>
                  ...
                  <Routes>
                    ...
                    <Route path="/category/:slug/page/:pageNumber" element={<CategoryPage />} />
                    
            {/* Web3 for India Routes - Separate Layout */}
            <Route path="/web3forindia" element={<Web3Layout />}>
              <Route index element={<Web3ForIndia />} />
              <Route path="dashboard" element={<Web3Dashboard />} />
              <Route path="playground" element={<Web3CodePlayground />} />
              <Route path="snippet/:slug" element={<Web3SnippetPage />} />
              <Route path="learning-path/:slug" element={<Web3LearningPathDetail />} />
              <Route path="verify/:code" element={<Web3CertificateVerify />} />
              <Route path="sitemap.xml" element={<Web3SitemapXML />} />
              <Route path="about" element={<Web3AboutPage />} />
              {/* Support both URL patterns for backwards compatibility */}
              <Route path="article/:slug" element={<Web3ArticlePage />} />
              <Route path=":categorySlug/:articleSlug" element={<Web3ArticlePage />} />
              <Route path=":categorySlug" element={<Web3CategoryPage />} />
            </Route>

            {/* UPSCBriefs Routes - UPSC Preparation Section */}
            <Route path="/upscbriefs" element={<UPSCLayout />}>
              <Route index element={<UPSCBriefs />} />
              <Route path="dashboard" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCDashboardPage /></React.Suspense>} />
              <Route path="about" element={<UPSCAboutPage />} />
              <Route path="prelims" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCPrelimsPage /></React.Suspense>} />
              <Route path="mains" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCMainsPage /></React.Suspense>} />
              <Route path="current-affairs" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCCurrentAffairsPage /></React.Suspense>} />
              <Route path="practice" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCPracticePage /></React.Suspense>} />
              <Route path="flashcards" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCFlashcardsPage /></React.Suspense>} />
              <Route path="quiz/:quizId" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCQuizPage /></React.Suspense>} />
              <Route path="resources" element={<React.Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}><UPSCResourcesPage /></React.Suspense>} />
              ...
              <Route path=":categorySlug" element={<UPSCCategoryPage />} />
                    ...
                    <Route path="/:parentSlug/:childSlug/page/:pageNumber" element={<CategoryPage />} />
          ...
          {/* Jobs subcategories now use normal CategoryPage like other categories */}
          <Route path="/admin/pyq" element={<AdminExamPapers />} />
          <Route path="/web-stories" element={<WebStoryIndex />} />
          <Route path="/amp-story/:category/:slug" element={<WebStoryPage />} />
          <Route path="/admin/web-stories/preview/:slug" element={<WebStoryPreview />} />
                    ...
                    <Route path="/admin" element={<AdminLayout />}>
                      ...
                      {/* UPSC Admin Routes */}
                      <Route path="upsc/quizzes" element={<AdminUPSCQuizzes />} />
                      <Route path="upsc/flashcards" element={<AdminUPSCFlashcards />} />
                      <Route path="upsc/notes" element={<AdminUPSCNotes />} />
                      <Route path="upsc/pyq-questions" element={<AdminUPSCPYQQuestions />} />
                      <Route path="image-migration" element={<AdminImageMigration />} />
                    </Route>
