...
import { 
  ...
  ArrowRight, Check, Newspaper, Blocks, BookOpen
} from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 bg-muted/30">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Explore More from TheBulletinBriefs</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover our other sections for news, tutorials, and visual stories
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              ...
              <Link to="/web3forindia" className="group">
                <Card className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/50">
                  <CardContent className="p-6 text-center">
                    <div className="w-14 h-14 rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-500 mx-auto mb-4 group-hover:bg-purple-500 group-hover:text-white transition-colors">
                      <Blocks className="w-7 h-7" />
                    </div>
                    <h3 className="font-semibold text-lg mb-2">Web3 for India</h3>
                    <p className="text-sm text-muted-foreground">Learn blockchain, crypto & smart contracts</p>
                  </CardContent>
                </Card>
              </Link>
              ...
              <Link to="/web-stories" className="group">
                <Card className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/50">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Visual stories for quick news updates</p>
                  </CardContent>
                </Card>
              </Link>
              ...
              <Link to="/#videos" className="group">
                <Card className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/50">
                  <CardContent className="p-6 text-center">
                    <div className="w-14 h-14 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-500 mx-auto mb-4 group-hover:bg-blue-500 group-hover:text-white transition-colors">
                      <Video className="w-7 h-7" />
                    </div>
                    <h3 className="font-semibold text-lg mb-2">Videos</h3>
                    <p className="text-sm text-muted-foreground">Watch latest video updates & news</p>
                  </CardContent>
                </Card>
              </Link>
            </div>
