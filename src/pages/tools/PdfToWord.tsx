  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.thebulletinbriefs.in/tools/pdf-to-word" />
        
        <meta property="og:title" content="PDF to Word Converter – Convert PDF to Editable DOCX" />
        <meta property="og:image" content="https://www.thebulletinbriefs.in/og-images/pdf-to-word.jpg" />
