...
import { Upload, Download, X, ArrowLeft, FileText, Scissors } from "lucide-react";
...
export default function SplitPdf() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        <title>Split PDF Files Online – Free PDF Splitter | TheBulletinBriefs</title>
        <meta
          name="description"
          content="Extract or split pages from PDF easily. 100% free online PDF splitter, no signup required."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://thebulletinbriefs.in/tools/split-pdf/" />
        
        <meta property="og:title" content="Split PDF Files Online – Free PDF Splitter" />
        <meta property="og:description" content="Extract or split pages from PDF easily. 100% free online PDF splitter, no signup required." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://thebulletinbriefs.in/tools/split-pdf/" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Split PDF Files Online – Free PDF Splitter" />
        <meta name="twitter:description" content="Extract or split pages from PDF easily. 100% free online PDF splitter, no signup required." />
