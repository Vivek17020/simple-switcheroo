...
export default function MergePdf() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        <title>Merge PDF Files Online – Combine PDFs Free | TheBulletinBriefs</title>
        <meta
          name="description"
          content="Easily merge multiple PDFs into one in seconds. Free, secure, and no signup needed."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://thebulletinbriefs.in/tools/merge-pdf/" />
        
        <meta property="og:title" content="Merge PDF Files Online – Combine PDFs Free" />
        <meta property="og:description" content="Easily merge multiple PDFs into one in seconds. Free, secure, and no signup needed." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://thebulletinbriefs.in/tools/merge-pdf/" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Merge PDF Files Online – Combine PDFs Free" />
        <meta name="twitter:description" content="Easily merge multiple PDFs into one in seconds. Free, secure, and no signup needed." />
