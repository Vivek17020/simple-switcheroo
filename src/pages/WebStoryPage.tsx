...
import { generateWebStoryStructuredData } from '@/utils/web-story-schema';
...
export default function WebStoryPage() {
  ...
  const storyUrl = `${baseUrl}/webstories/${storyData.category.toLowerCase()}/${storyData.slug}`;
  const ampUrl = `${baseUrl}/amp-story/${storyData.slug}`;
  ...
  const structuredData = generateWebStoryStructuredData(storyData);
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Self-referencing canonical URL for non-AMP version */}
        <link rel="canonical" href={storyUrl} />
        
        {/* Link to AMP version for Google Discover and Search Console */}
          ...
          <div className="relative w-full h-full overflow-hidden">
            ...
            {currentSlideData.text && (
              <div 
                ...
                className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-8 animate-slide-in-bottom"
              >
