...
import { useCategoryRobots } from "@/hooks/use-category-robots";
...
const UPSCCategoryPage = () => {
  ...
  // Dynamic robots meta based on article count (noindex if < 3 articles)
  const { shouldIndex, robotsContent } = useCategoryRobots(category?.id, true);
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4">
            <div
              className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-300 hover:scale-110"
