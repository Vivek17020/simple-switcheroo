  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href={`https://www.thebulletinbriefs.in/web3forindia/article/${article.slug}`} />
      ...
      <Web3StructuredData
        ...
        data={{
          ...
          articleUrl: `https://www.thebulletinbriefs.in/web3forindia/article/${article.slug}`,
        }}
      />
      ...
      <Web3StructuredData
        ...
        data={{
          breadcrumbs: [
            ...
            { name: article.title, url: `https://www.thebulletinbriefs.in/web3forindia/article/${article.slug}` },
          ],
        }}
      />
