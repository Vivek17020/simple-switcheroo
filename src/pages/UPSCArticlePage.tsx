...
import { Clock, Calendar, ArrowLeft, Share2, Download } from "lucide-react";
...
import { UPSCBookmarkButton } from "@/components/upsc/UPSCBookmarkButton";
import { UPSCProgressButton } from "@/components/upsc/UPSCProgressButton";
...
import { generateUPSCArticlePDF } from "@/lib/upsc-pdf-generator";
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header className="mb-8">
          ...
          {/* Action Buttons */}
          <div className="flex flex-wrap items-center gap-2 py-3 px-4 bg-gray-50 rounded-lg border border-gray-100">
            <UPSCProgressButton articleId={article.id} />
            <UPSCBookmarkButton articleId={article.id} variant="outline" />
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <UPSCProgressButton articleId={article.id} variant="outline" />
              <UPSCBookmarkButton articleId={article.id} />
            </div>
            <div className="flex items-center gap-2">
