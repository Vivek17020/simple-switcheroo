        ...
        <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
          ...
          {currentSlideData.text && (
            <div 
              ...
              className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-8 animate-in slide-in-from-bottom fade-in duration-500"
