...
import { Blocks, Code, Coins, FileCode, Landmark, Palette, Shield, Newspaper, Wrench, BookOpen, GraduationCap } from "lucide-react";
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              ...
              <Link to="/upscbriefs" className="group">
                <Card className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 hover:border-[#6A5BFF]/50 bg-card">
                  <CardContent className="p-6 text-center">
                    <div className="w-14 h-14 rounded-xl bg-blue-600/10 flex items-center justify-center text-blue-600 mx-auto mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                      <GraduationCap className="w-7 h-7" />
                    </div>
                    <h3 className="font-semibold text-lg mb-2 text-foreground">UPSCBriefs</h3>
                    <p className="text-sm text-muted-foreground">UPSC preparation made simple</p>
                  </CardContent>
                </Card>
              </Link>
