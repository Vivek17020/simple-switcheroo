...
import { Blocks, Code, Coins, FileCode, Landmark, Palette, Shield } from "lucide-react";
        ...
        <div className="container mx-auto px-4 pb-16">
          ...
          <section className="mb-20" id="tutorials">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">Explore Web3 Topics</h2>
              <p className="text-gray-600 text-lg">Choose a learning path and start your Web3 journey</p>
            </div>
          ...
          <section className="mb-20" id="learning-paths">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">Recommended Learning Paths</h2>
              <p className="text-gray-600 text-lg">Structured curriculum to master Web3 from basics to advanced</p>
            </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-3">Latest Tutorials</h2>
                <p className="text-gray-600 text-lg">Fresh content added regularly</p>
              </div>
            </div>
