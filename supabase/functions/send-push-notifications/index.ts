...
serve(async (req) => {
  ...
  try {
    ...
    const payload: NotificationPayload = {
      ...
      icon: 'https://www.thebulletinbriefs.in/tb-briefs-favicon.png',
      badge: 'https://www.thebulletinbriefs.in/tb-briefs-favicon.png',
      url: `https://www.thebulletinbriefs.in/article/${articleId}`
    };
