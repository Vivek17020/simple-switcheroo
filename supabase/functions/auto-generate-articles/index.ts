...
MISSION: Find ${articleCount} NEWS STORIES published in the LAST 10 MINUTES by major news sources.

CRITICAL REQUIREMENTS:
✓ Must be published within the last 5-10 minutes (REAL-TIME news)
✓ Must be breaking news or just-announced updates
✓ Must be from verified news sources (PTI, ANI, Reuters, TOI, Hindustan Times, etc.)
✓ Must be trending RIGHT NOW in India
...
- Finance: JUST ANNOUNCED stock movements, RBI decisions, market updates
- Technology: BREAKING tech announcements, product launches happening NOW
- Business: FRESH company news, mergers, IPO announcements TODAY
- Education: JUST RELEASED exam results, admission notifications TODAY
- Defence: BREAKING military/defense news, security updates NOW
- Politics: LIVE political developments, policy announcements TODAY
- Sports: ONGOING matches, JUST FINISHED games, breaking sports news
- World: BREAKING international news happening RIGHT NOW
...
- Optimize for Google Discover's "breaking news" signals`
        ...
        // Schedule publishing soon (within 15-30 minutes to stay competitive)
        const minutesDelay = 15 + (i * 5); // Publish within 15-30 minutes (stagger by 5 min each)
