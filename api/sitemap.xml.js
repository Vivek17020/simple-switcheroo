...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Static pages - INCLUDING Web3ForIndia and Tools as major sections
    const staticPages = [
      { path: '/', changefreq: 'daily', priority: '1.0' },
      // Major sections - CRITICAL for cross-section linking
      { path: '/web3forindia', changefreq: 'daily', priority: '0.9' },
      { path: '/web3forindia/dashboard', changefreq: 'weekly', priority: '0.8' },
      { path: '/web3forindia/about', changefreq: 'monthly', priority: '0.7' },
      { path: '/tools', changefreq: 'weekly', priority: '0.9' },
      { path: '/tools/pdf-tools', changefreq: 'weekly', priority: '0.8' },
      { path: '/tools/image-tools', changefreq: 'weekly', priority: '0.8' },
      { path: '/tools/video-tools', changefreq: 'weekly', priority: '0.8' },
      // Other static pages
